...
# AYEO, 2020-Mar-19, added Track class code, TODO Test
# AYEO, 2020-Mar-19, added Track class methods, TODO Test
# AYEO, 2020-Mar-19, Modified CD class as required, TODO Test
# AYEO, 2020-Mar-19, Added append and sort track for CD.add_track() method, TODO Test
# AYEO, 2020-Mar-19, Added append and sort track for CD.rmv_track() method, TODO Test
# AYEO, 2020-Mar-19, Fixed a bug where rmv_track crashed because it using a string to subtract.  Made track_id into int(track_id)
# AYEO, 2020-Mar-19, Found bug where raising Exception('No tracks saved for this Album') crashes the program
#------------------------------------------#
