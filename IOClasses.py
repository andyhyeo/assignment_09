...
# AYEO, 2020-Mar-19, modified save_inventory( method to accept a list of file names.
# AYEO, 2020-Mar-19, modified save_inventory( method to save track data to file.
# AYEO, 2020-Mar-19, modified load_inventory method to accept a list of file names 
# AYEO, 2020-Mar-19, modified load_inventory method to load track data
#------------------------------------------#
...
class ScreenIO:
    ...
    def menu_choice():
        ...
        """
        choice = ' '
        while choice not in ['l', 'a', 'i', 'd', 'c', 's', 'x']:
            choice = input('Which operation would you like to perform? [l, a, i, d, c, s or x]: ').lower().strip()
    ...
    def menu_CD_choice():
        ...
        """
        choice = ' '
        while choice not in ['a', 'i', 'r', 'x']:
            choice = input('Which operation would you like to perform? [a, i, r or x]: ').lower().strip()
        print()  # Add extra space for layout
        return choice
