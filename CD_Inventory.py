...
# AYEO, 2020-Mar-19, Added code to handle tracks on an individual CD, TODO Test
# AYEO, 2020-Mar-19, Added code to delete CD/Album
# AYEO, 2020-Mar-20, 
#------------------------------------------#
...
while True:
    ...
    if strChoice == 'l':
        ...
        cd = PC.DataProcessor.delete_cd(lstOfCDObjects, cd_idx)
        IO.ScreenIO.show_inventory(lstOfCDObjects)        
    elif strChoice == 'c':
        IO.ScreenIO.show_inventory(lstOfCDObjects)
        cd_idx = input('Select the CD / Album index: ')
#        PC.DataProcessor.select_cd(lstOfCDObjects, cd_idx)
        IO.ScreenIO.show_inventory(lstOfCDObjects)
